...
At the end of the semester there will be a last chance regrade option for two weeks of machine problem grades. To be able to take advantage of this opportunity you will need to have a perfect attendance grade after the drops. If you submit a test case for an assignment that accurately matches the assignment _description_ not the documentation along with a justification for why, then you may get one more week of machine problem regrade -- this is up to the course staff's discretion.
